    ...
    <div className="p-4 lg:p-6 bg-gradient-to-br from-sky-50 to-white min-h-screen">
      ...
      {projects.length === 0 ? (
        <div className="flex flex-col items-center justify-center min-h-64">
          <p className="text-gray-500 text-lg text-center">No projects available. Create one!</p>
        </div>
      ) : (
        ...
        <div className="space-y-4">
          ...
          <div>
            <textarea
              ...
              className="w-full px-3 py-2 border rounded-lg resize-none min-h-[6rem] max-h-32 overflow-y-scroll focus:outline-none focus:ring-2 focus:ring-sky-500"
              placeholder="Project description"
            />
          </div>
          <div className="flex gap-2">
            <Button onClick={() => { updateProject(editingProject, { name: editName, description: editDescription }); setEditingProject(null); }}>
              Save
            </Button>
